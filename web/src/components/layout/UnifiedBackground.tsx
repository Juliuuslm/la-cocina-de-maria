...
export const UnifiedBackground: React.FC<UnifiedBackgroundProps> = ({ children }) => {
  // Parallax hooks para elementos decorativos - solo en desktop
  const cazuela1 = useParallax({ speed: 0.3, direction: 'up' });
  const knife1 = useParallax({ speed: 0.4, direction: 'down' });
  const spoon1 = useParallax({ speed: 0.2, direction: 'up' });
  const pot1 = useParallax({ speed: 0.35, direction: 'down' });
  const pan1 = useParallax({ speed: 0.25, direction: 'up' });
  const metate1 = useParallax({ speed: 0.3, direction: 'down' });
  ...
  return (
    <div className="relative min-h-[100dvh] md:min-h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-yellow-50 w-full max-w-full overflow-x-hidden">
      ...
      <div className="absolute inset-0 overflow-x-hidden">
        ...
        {/* Cazuela - middle left with parallax */}
        <motion.div 
          ref={cazuela1.ref}
          style={{ y: cazuela1.y }}
          className="absolute top-1/3 left-2 sm:left-12 md:left-16 opacity-18 hidden lg:block"
        >
        ...
        {/* Cazuela - static for mobile */}
        <div className="absolute top-1/3 left-2 sm:left-12 md:left-16 opacity-18 lg:hidden">
          <svg width="70" height="70" viewBox="0 0 80 80" fill="none">
            <ellipse cx="40" cy="60" rx="22" ry="7" fill="#8B4513" opacity="0.8"/>
            <rect x="18" y="40" width="44" height="20" rx="3" fill="#A0522D" opacity="0.9"/>
            <ellipse cx="40" cy="40" rx="22" ry="7" fill="#CD853F" opacity="0.9"/>
        ...
        {/* Large knife - middle right with parallax */}
        <motion.div 
          ref={knife1.ref}
          style={{ y: knife1.y }}
          className="absolute top-2/5 right-2 sm:right-12 md:right-16 opacity-15 hidden lg:block"
        >
        ...
        {/* Large knife - static for mobile */}
        <div className="absolute top-2/5 right-2 sm:right-12 md:right-16 opacity-15 lg:hidden">
          <svg width="45" height="70" viewBox="0 0 50 80" fill="none">
            <rect x="23" y="15" width="4" height="45" rx="2" fill="#C0C0C0" opacity="0.9"/>
            <path d="M20 15 L30 15 L30 40 L25 45 Z" fill="#DCDCDC" opacity="0.8"/>
            <rect x="21" y="45" width="8" height="20" rx="4" fill="#8B4513" opacity="0.8"/>
        ...
        {/* Wooden spoon - middle left area with parallax */}
        <motion.div 
          ref={spoon1.ref}
          style={{ y: spoon1.y }}
          className="absolute top-3/5 left-2 sm:left-16 md:left-20 opacity-16 hidden lg:block"
        >
        ...
        {/* Wooden spoon - static for mobile */}
        <div className="absolute top-3/5 left-2 sm:left-16 md:left-20 opacity-16 lg:hidden">
          <svg width="45" height="65" viewBox="0 0 60 80" fill="none">
            <ellipse cx="30" cy="20" rx="15" ry="10" fill="#D2691E" opacity="0.8"/>
            <ellipse cx="30" cy="18" rx="12" ry="8" fill="#DEB887" opacity="0.9"/>
            <rect x="27" y="25" width="6" height="40" rx="3" fill="#D2691E" opacity="0.8"/>
        ...
        {/* Large pot - middle right area with parallax */}
        <motion.div 
          ref={pot1.ref}
          style={{ y: pot1.y }}
          className="absolute top-1/2 right-2 sm:right-16 md:right-20 opacity-17 hidden lg:block"
        >
        ...
        {/* Large pot - static for mobile */}
        <div className="absolute top-1/2 right-2 sm:right-16 md:right-20 opacity-17 lg:hidden">
          <svg width="65" height="65" viewBox="0 0 70 70" fill="none">
            <ellipse cx="35" cy="55" rx="18" ry="5" fill="#8B4513" opacity="0.8"/>
            <rect x="17" y="38" width="36" height="17" rx="2" fill="#A0522D" opacity="0.9"/>
            <ellipse cx="35" cy="38" rx="18" ry="5" fill="#CD853F" opacity="0.9"/>
        ...
        {/* Pan - bottom left with parallax */}
        <motion.div 
          ref={pan1.ref}
          style={{ y: pan1.y }}
          className="absolute bottom-32 left-2 sm:left-12 md:left-16 opacity-18 hidden lg:block"
        >
        ...
        {/* Pan - static for mobile */}
        <div className="absolute bottom-32 left-2 sm:left-12 md:left-16 opacity-18 lg:hidden">
          <svg width="75" height="45" viewBox="0 0 90 50" fill="none">
            <ellipse cx="30" cy="30" rx="22" ry="15" fill="#2F4F4F" opacity="0.8"/>
            <ellipse cx="30" cy="27" rx="20" ry="13" fill="#696969" opacity="0.9"/>
            <ellipse cx="30" cy="25" rx="18" ry="11" fill="#A9A9A9" opacity="0.7"/>
        ...
        {/* Metate - bottom left area with parallax */}
        <motion.div 
          ref={metate1.ref}
          style={{ y: metate1.y }}
          className="absolute bottom-16 left-1/3 opacity-17 hidden lg:block"
        >
        ...
        {/* Metate - static for mobile */}
        <div className="absolute bottom-16 left-1/3 opacity-17 lg:hidden">
          <svg width="70" height="40" viewBox="0 0 80 45" fill="none">
            <ellipse cx="40" cy="30" rx="30" ry="10" fill="#2F4F4F" opacity="0.8"/>
            <ellipse cx="40" cy="27" rx="27" ry="8" fill="#696969" opacity="0.9"/>
            <ellipse cx="20" cy="40" rx="5" ry="3" fill="#2F4F4F" opacity="0.8"/>
